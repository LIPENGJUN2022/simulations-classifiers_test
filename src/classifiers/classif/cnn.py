...
class AACnnClassifier(CnnClassifier):
    ...
    **kwargs : dict
    ...
    def __init__(self, data: Data, max_width: int | None = None, *args, **kwargs):
        super().__init__(data, *args, max_width=max_width, **kwargs)

        self.model = AAConvNet(n_features=self.n_features, n_sites=self.dataset.max_length)
...
class DNACnnClassifier(CnnClassifier):
    ...
    **kwargs : dict
    ...
    def __init__(self, data: Data, max_width: int | None = None, *args, **kwargs):
        ...
        self.model = DNAConvNet(n_features=self.n_features, n_sites=self.dataset.max_length)
